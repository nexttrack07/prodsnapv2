[Skip to main content](https://clerk.com/docs/nextjs/guides/billing/for-b2c#main)

# Clerk Billing for B2C SaaS

1. [Enable Billing](https://clerk.com/docs/nextjs/guides/billing/for-b2c#enable-billing)
1. [Payment gateway](https://clerk.com/docs/nextjs/guides/billing/for-b2c#payment-gateway)
2. [Create a Plan](https://clerk.com/docs/nextjs/guides/billing/for-b2c#create-a-plan)
3. [Add Features to a Plan](https://clerk.com/docs/nextjs/guides/billing/for-b2c#add-features-to-a-plan)
4. [Create a pricing page](https://clerk.com/docs/nextjs/guides/billing/for-b2c#create-a-pricing-page)
5. [Control access with Features and Plans](https://clerk.com/docs/nextjs/guides/billing/for-b2c#control-access-with-features-and-plans)
1. [Example: Using `has()`](https://clerk.com/docs/nextjs/guides/billing/for-b2c#example-using-has)
2. [Example: Using `<Show>`](https://clerk.com/docs/nextjs/guides/billing/for-b2c#example-using-show)
...
[Open inOpen in ChatGPTOpenAI](https://chatgpt.com/?q=Read+https%3A%2F%2Fclerk.com%2Fdocs%2Fnextjs%2Fguides%2Fbilling%2Ffor-b2c.md&hints=search)
...
### [Payment gateway](https://clerk.com/docs/nextjs/guides/billing/for-b2c\#payment-gateway)
...
## [Create a Plan](https://clerk.com/docs/nextjs/guides/billing/for-b2c\#create-a-plan)
...
## [Add Features to a Plan](https://clerk.com/docs/nextjs/guides/billing/for-b2c\#add-features-to-a-plan)
...
## [Create a pricing page](https://clerk.com/docs/nextjs/guides/billing/for-b2c\#create-a-pricing-page)

You can create a pricing page by using the [<PricingTable />](https://clerk.com/docs/nextjs/reference/components/billing/pricing-table) component. This component displays a table of Plans and Features that users can subscribe to. **It's recommended to create a dedicated page**, as shown in the following example.
...
## [Control access with Features and Plans](https://clerk.com/docs/nextjs/guides/billing/for-b2c\#control-access-with-features-and-plans)
...
### [Example: Using `has()`](https://clerk.com/docs/nextjs/guides/billing/for-b2c\#example-using-has)
...
### [Example: Using `<Show>`](https://clerk.com/docs/nextjs/guides/billing/for-b2c\#example-using-show)
